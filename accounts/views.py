...
def login(request):
    if request.user.is_authenticated:
        ...
        # AUTHENTICATE FUNCTION FROM DJANGO 
...
def forget_password(request):
    if request.method == 'POST':
        ...
        # Checking email is exist in db
        if User.objects.filter(email=email).exists():

            # Checking case insensitive match on the field name
            ...
            messages.success(request, "Account is not exist")
